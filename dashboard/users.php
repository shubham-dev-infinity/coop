                            ...
                            <div class="inner-con" style="width: 100%;">
                                ...
                                <div class="card">
                                    ...
                                    <div class="row" style="justify-content: right;padding-right: 20px;">
                                        ...
                                        <button type="button" id="user_export" class="btn btn-success cardrelease mb-2" style="width: 10vw;margin-right:2px">Export</button>
                                        <a href="all_users.txt" id="downloadFrame" target="_blank" class="" style="width: 10vw;margin-left:1ox;">Download</a>
                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                            <tr class="row-<?php echo $row['id']; ?> <?php echo $rowstatus; ?>" data-num-users="<?php echo $number_users; ?>">
                                                                ...
                                                                <td data-id="<?php echo $row['id']; ?>" class="card_number"><?php echo $row['cardnumber']; ?><br>
                                                                ...
                                                                <td data-id="<?php echo $row['id']; ?>">
                                                                    ...
                                                                    <select class="form-select cardstatus" name="cardstatus" userid="<?php echo $row['id']; ?>">
                                                                        ...
                                                                        <option value="release">卡放行</option>
                                                                        <option value="refuse">卡拒绝</option>
