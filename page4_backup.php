 ...
 <div class="wrap">
    ...
    padding-bottom: 10px;">
                 ...
                 <font style="vertical-align: inherit;">
                     <font style="vertical-align: inherit;"><span style="color:red;">*</span>La entrega del premio corre a cargo del servicio postal mexicano.Pagará MXN$5.0 por el servicio</font>
                 </font>
             </h5>
                 ...
                 <table class="cstm-table" border="0" width="100%">
                     ...
                     <tbody>
                         ...
                         <tr>
                             ...
                             <td>$<?php echo isset($_SESSION['total_quantity']['quantity']) ? $_SESSION['total_quantity']['quantity'] : 5.0   ?></td>
                         </tr>
                     </tbody>
